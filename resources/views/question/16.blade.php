...
<body>
    ...
    <section class="container">
        ...
        <section id="question">
            ...
            <div id="content">
                Dibawah ini persendian yang pergerakannya sangat terbatas, misalnya pada sambungan antara ruas-ruas
                tulang belakang yang dihubungkan oleh tulang rawan fibrosa adalah …
            </div>
            ...
            <form autocomplete="off" action="/quiz/answer" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="number" hidden name="question" value="16">
