        ...
        <section id="question">
            ...
            <div id="content">
                ...
                <div class="soal-gambar">
                    <img src="/img/9.png" width="150px" height="150px" alt="">
                </div>
            </div>
            <div class="content-soal">
                Berdasarkan gambar diatas tulang yang terdiri dari lima tulang belakang adalah ...
            </div>
            <form autocomplete="off" action="/quiz/answer" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="number" hidden name="question" value="9">
