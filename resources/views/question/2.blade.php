...
<body>
    ...
    <section class="container">
        ...
        <section id="question">
            ...
            <div id="content">
                Berikut ini ciri-ciri Jenis tulang keras berdasarkan matriks penyusunnya
                <ul>
                    <li>Memiliki matriks retikuler yang berbentuk lingkaran (sistem havers)</li>
                    <li>Setiap matriksnya mengandung pembuluh darah dan sel saraf</li>
                    <li>Tidak memiliki banyak rongga</li>
                </ul>
            </div>
            <div class="content-soal">
                jenis tulang yang dimaksud adalah ...
            </div>
