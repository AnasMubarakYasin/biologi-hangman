...
<body>
    ...
    <section class="container">
        ...
        <section id="question">
            ...
            <div id="content">
                Kelainan pada tulang dimana terjadi penumpukan bahan kapur diantara dua tulang sehingga menyebabkan
            ...
            <form autocomplete="off" action="/quiz/answer" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="number" hidden name="question" value="24">
    ...
    <script>
        function next(e) {
            if (e.nextElementSibling.disabled) {
